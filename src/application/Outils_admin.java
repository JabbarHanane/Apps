...
public class Outils_admin extends Application {
     ...
     //   bt3.setTranslateX(150);
      //  bt3.setTranslateY(200);
       ...
       // bt4.setStyle("-fx-background-color: teal;");
        ...
        //insérer breaaak_image*****
        ImageView im3=new ImageView(image1);
	      im3.setTranslateX(30);
	      grid.getChildren().add(im3);
        ...
        //boutton Modifier**********
        JFXButton bt6=new JFXButton("Modifier");
        bt6.setContentDisplay(ContentDisplay.TOP);
        bt6.setAlignment(Pos.BOTTOM_CENTER);
    
        bt6.setPrefSize(125, 20);
        bt6.setTextFill(Color.WHITE);
        bt6.setGraphic(new ImageView("image/modifierU.png"));
        //bt6.setTranslateX(150); 
       // bt6.setTranslateY(500);
        bt6.setFont(new Font(17));
      //  bt6.setStyle("-fx-background-color:  teal;");
        grid.getChildren().add(bt6);
        
        //Activer ModifierUsers
	       bt6.setOnMouseClicked((MouseEvent me) -> {
	    	   stage.close();
		       Stage s=new Stage();
       	   ModifierU a =new  ModifierU(); 
	          try {
				a.start(s);
			} catch (Exception e) {
				// TODO Auto-generated catch block
      	        ...
      	        String sql0="select id from autho where login =? ";
      	             try {
      	               ...
      	               //recherche d'heure de pointage*****
      	            	   cnn=(Connection) connecterBD.connexionBD();
      	       	                   	String sql1="select pointu from pointage where id=?";
      	       	                   	try{
